...
// LEETCODE:790:DOMINO AND TROMINO TILLING:
...
public class L790 {
    public static int numTilings(int n) {
        ...
        partTiling[1] = 0;
        // If 1 cell out of 4 (2 pair of cells) is already filled then a tromino can
        // fill the remaining 3 cells
        partTiling[2] = 1;
    ...
    public static void main(String[] args) {
        ...
        int n = 5;
        System.out.println(numTilings(n)); // Output: 24
    }
}
